    ...
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="/login" method="post" id="loginForm">
                ...
                <div class="wrap-input100 validate-input" data-validate = "Username is not valid. Only characters A-Z, a-z, .-_ are allowed">
...
<script>
    ...
    let regexUsername = /^[a-zA-Z0-9]([._-](?![._-])|[a-zA-Z0-9]){3,18}[a-zA-Z0-9]$/;
    let regexPassword = /^[a-zA-Z@#$%^&+=](?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=]).{8,}[a-zA-Z0-9]$/;
